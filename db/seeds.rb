...
#
User.create(user_name: 'A', user_email: 'a@gmail.com', organization: "CSUA", admin_status: 1, user_prime: 2, votes: '{"csua_04012016_President":"3"}')
User.create(user_name: 'B', user_email: 'b@gmail.com', organization: "CSUA", admin_status: 1, user_prime: 3, votes: '{"csua_04012016_President":"3"}')
User.create(user_name: 'B', user_email: 'b@gmail.com', organization: "HKN", admin_status: 1, user_prime: 5, votes: '{"hkn_04012016_President":"7"}')
